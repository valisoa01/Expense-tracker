...
|---|---|---|
| ![Liste sombre](screenshots/home_page_dark.png) | ![Liste claire](screenshots/home_page_light.png) | ![Recherche](screenshots/filter_search.png) |

| Détail | Formulaire | Statistiques |
|---|---|---|
| ![Détail](screenshots/expense_detail.png) | ![Formulaire](screenshots/add_expense.png) | ![Stats](screenshots/expense_stats.png) |
